...
// import { Expo, Quad, Power2 } from "gsap";
...
// 	gsap.to(eyeL, {x: -eyeLX , y: -eyeLY, ease: Expo.easeOut});
// 	gsap.to(eyeR, {x: -eyeRX , y: -eyeRY, ease: Expo.easeOut});
// 	gsap.to(nose, {x: -noseX, y: -noseY, rotation: mouthR, transformOrigin: "center center", ease: Expo.easeOut});
// 	gsap.to(mouth, {x: -mouthX , y: -mouthY, rotation: mouthR, transformOrigin: "center center", ease: Expo.easeOut});
// 	gsap.to(chin, {x: -chinX, y: -chinY, scaleY: chinS, ease: Expo.easeOut});
// 	gsap.to(face, {x: -faceX, y: -faceY, skewX: -faceSkew, transformOrigin: "center top", ease: Expo.easeOut});
// 	gsap.to(eyebrow, {x: -faceX, y: -faceY, skewX: -eyebrowSkew, transformOrigin: "center top", ease: Expo.easeOut});
// 	gsap.to(outerEarL, {x: outerEarX, y: -outerEarY, ease: Expo.easeOut});
// 	gsap.to(outerEarR, {x: outerEarX, y: outerEarY, ease: Expo.easeOut});
// 	gsap.to(earHairL, {x: -outerEarX, y: -outerEarY, ease: Expo.easeOut});
// 	gsap.to(earHairR, {x: -outerEarX, y: outerEarY, ease: Expo.easeOut});
// 	gsap.to(hair,  {x: hairX, scaleY: hairS, transformOrigin: "center bottom", ease: Expo.easeOut});	
...
// 			mouthStatus = "medium";
// 			gsap.to([mouthBG, mouthOutline, mouthMaskPath], 1, {morphSVG: mouthMediumBG, shapeIndex: 8, ease: Expo.easeOut});
// 			gsap.to(tooth, {x: 0, y: 0, ease: Expo.easeOut});
// 			gsap.to(tongue, {x: 0, y: 1, ease: Expo.easeOut});
// 			gsap.to([eyeL, eyeR], {scaleX: .85, scaleY: .85, ease: Expo.easeOut});
// 			eyeScale = .85;
// 		}
// 		if(value.includes("@")) {
// 			mouthStatus = "large";
// 			gsap.to([mouthBG, mouthOutline, mouthMaskPath], 1, {morphSVG: mouthLargeBG, ease: Expo.easeOut});
// 			gsap.to(tooth, {x: 3, y: -2, ease: Expo.easeOut});
// 			gsap.to(tongue, {y: 2, ease: Expo.easeOut});
// 			gsap.to([eyeL, eyeR], {scaleX: .65, scaleY: .65, ease: Expo.easeOut, transformOrigin: "center center"});
// 			eyeScale = .65;
// 		} else {
// 			mouthStatus = "medium";
// 			gsap.to([mouthBG, mouthOutline, mouthMaskPath], 1, {morphSVG: mouthMediumBG, ease: Expo.easeOut});
// 			gsap.to(tooth, {x: 0, y: 0, ease: Expo.easeOut});
// 			gsap.to(tongue, {x: 0, y: 1, ease: Expo.easeOut});
// 			gsap.to([eyeL, eyeR], {scaleX: .85, scaleY: .85, ease: Expo.easeOut});
// 			eyeScale = .85;
...
// 	} else {
// 		mouthStatus = "small";
// 		gsap.to([mouthBG, mouthOutline, mouthMaskPath], 1, {morphSVG: mouthSmallBG, shapeIndex: 9, ease: Expo.easeOut});
// 		gsap.to(tooth, {x: 0, y: 0, ease: Expo.easeOut});
// 		gsap.to(tongue, {y: 0, ease: Expo.easeOut});
// 		gsap.to([eyeL, eyeR], {scaleX: 1, scaleY: 1, ease: Expo.easeOut});
// 		eyeScale = 1;
// 	}
// }
...
// 	gsap.to(twoFingers, .35, {transformOrigin: "bottom left", rotation: 30, x: -9, y: -2, ease: Power2.easeInOut});
// }

// function closeFingers() {
// 	gsap.to(twoFingers, .35, {transformOrigin: "bottom left", rotation: 0, x: 0, y: 0, ease: Power2.easeInOut});
// }

// function coverEyes() {
// 	gsap.killTweensOf([armL, armR]);
// 	gsap.set([armL, armR], {visibility: "visible"});
// 	gsap.to(armL, {x: -93, y: 10, rotation: 0, ease: Quad.easeOut});
// 	gsap.to(armR, {x: -93, y: 10, rotation: 0, ease: Quad.easeOut, delay: .1});
// 	gsap.to(bodyBG, {morphSVG: bodyBGchanged, ease: Quad.easeOut});
// 	eyesCovered = true;
// }

// function uncoverEyes() {
// 	gsap.killTweensOf([armL, armR]);
// 	gsap.to(armL, {y: 220, ease: Quad.easeOut});
// 	gsap.to(armL, {rotation: 105, ease: Quad.easeOut, delay: .1});
// 	gsap.to(armR, {y: 220, ease: Quad.easeOut});
// 	gsap.to(armR, {rotation: -105, ease: Quad.easeOut, delay: .1, onComplete: function() {
// 		gsap.set([armL, armR], {visibility: "hidden"});
// 	}});
// 	gsap.to(bodyBG, {morphSVG: bodyBG, ease: Quad.easeOut});
// 	eyesCovered = false;
// }

// function resetFace() {
// 	gsap.to([eyeL, eyeR], {x: 0, y: 0, ease: Expo.easeOut});
// 	gsap.to(nose, {x: 0, y: 0, scaleX: 1, scaleY: 1, ease: Expo.easeOut});
// 	gsap.to(mouth, {x: 0, y: 0, rotation: 0, ease: Expo.easeOut});
// 	gsap.to(chin, {x: 0, y: 0, scaleY: 1, ease: Expo.easeOut});
// 	gsap.to([face, eyebrow], {x: 0, y: 0, skewX: 0, ease: Expo.easeOut});
// 	gsap.to([outerEarL, outerEarR, earHairL, earHairR, hair], {x: 0, y: 0, scaleY: 1, ease: Expo.easeOut});
// }
...
// 		delay = 1;
// 	}
// 	blinking = gsap.to([eyeLRef, eyeRRef], {delay: delay, scaleY: 0, yoyo: true, repeat: 1, transformOrigin: "center center", onComplete: function() {
// 		startBlinking(12);
// 	}});
// }
...
// 	svgCoords = getPosition(mySvgRef);
// 	emailCoords = getPosition(emailRef);
// 	screenCenter = svgCoords.x + (mySvgRef.offsetWidth / 2);
...
// 	/*emailRef.addEventListener('focus', onEmailFocus);
// 	emailRef.addEventListener('blur', onEmailBlur);
...
// 	emailScrollMax = emailRef.scrollWidth;
	
// 	// check if we're on mobile/tablet, if so then show password initially
// 	if(isMobileDevice()) {
// 		password.type = "text";
// 		showPasswordCheck.checked = true;
// 		gsap.set(twoFingers, {transformOrigin: "bottom left", rotation: 30, x: -9, y: -2, ease: Power2.easeInOut});
// 	}
...
//                     </g>
//                     <g class="eyeL" ref={eyeLRef}>
//                         <circle cx="85.5" cy="78.5" r="3.5" fill="#3a5e77"/>
//                         <circle cx="84" cy="76" r="1" fill="#fff"/>
//                     </g>
//                     <g class="eyeR" ref={eyeRRef}>
...
//             <label for="loginEmail" id="loginEmailLabel" onClick={onEmailLabelClick}>Email</label>
//             <input type="email" id="loginEmail" maxlength="254" ref={emailRef} onFocus={onEmailFocus} onBlur={onEmailBlur} onInput={onEmailInput} />
//             <p class="helper helper1">email@domain.com</p>
//         </div>
//         <div class="inputGroup inputGroup2">
//             <label for="loginPassword" id="loginPasswordLabel" onFocus={onPasswordFocus} onBlur={onPasswordBlur}>Password</label>
//             <input type="password" id="loginPassword" />
//             <label id="showPasswordToggle" for="showPasswordCheck">Show
//                 <input id="showPasswordCheck" type="checkbox" onChange={onPasswordToggleChange} onFocus={onPasswordToggleFocus} onBlur={onPasswordToggleBlur} onClick={onPasswordToggleClick} onMouseUp={onPasswordToggleMouseUp} onMouseDown={onPasswordToggleMouseDown}/>
